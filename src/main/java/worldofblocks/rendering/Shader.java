...
public class Shader {
    ...
    private String readFile(String filename) {
        ...
        try {
            String shaderFilePath = "assets/shaders/" + filename;
            URL shaderUrl = getClass().getClassLoader().getResource(shaderFilePath);
            buffer = new BufferedReader(new InputStreamReader(shaderUrl.openStream()));
            String line;
